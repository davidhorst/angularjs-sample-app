  ...
  template: `
    <div layout="column" layout-padding>
      ...
      <p>
        ...
        <div>
          <md-button class="md-raised md-primary" ui-sref="mymessages"><i class="fa fa-envelope"></i><span>Messages</span></md-button>
          <md-button class="md-raised md-primary" ui-sref="contacts"><i class="fa fa-users"></i><span>Contacts</span></md-button>
          <md-button class="md-raised md-primary" ui-sref="prefs"><i class="fa fa-cogs"></i><span>Preferences</span></md-button>
        </div>
      </p>
